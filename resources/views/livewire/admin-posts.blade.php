        ...
        <div class="w-full">
            ...
            <div class="flex mb-5 flex-col gap-5">
                ...
                <div class="flex md:w-full grow mb-2">
                    ...
                    <button class="pb-2 px-3 border-b-4 font-semibold text-md border-dark-gray text-dark-gray">Oglasi na čekanju za odobravanje</button>
            ...
            <div class="space-y-7">
                ...
                @if (count($posts))
                    ...
                    @endforeach
                @else
                    <p class="w-full flex rounded-xl py-3 bg-white justify-center items-center text-red-500">Trenutno nema oglasa na čekanju</p>
                @endif
