            ...
            <div>
                <div class="flex flex-col gap-7 z-100">
                    ...
                    class="flex flex-col gap-2 items-start lg:hidden relative">
                        ...
                        <x-input class="w-full" wire:model="mesto" @click="showMesta = !showMesta" type="text" name="mesto" id="mesto" autocomplete="off"/>
                    ...
                    <div>            
                        <div class="range-slider flex flex-col">
                            ...
                            <div class="slider-wrapper mb-5">
                                <input wire:model="cena_od" min="0" max="10000" step="1" type="range">
                                <input wire:model="cena_do" min="0" max="10000" step="1" type="range">
                            </div>
                            ...
                            <div class="flex justify-between mdMin:flex-col mdMin:gap-2">
                                <div class="flex gap-1 items-center">
                                    ...
                                    <input wire:model="cena_od" id="cena_od" type="number" min="0" step="1" class="border rounded-lg p-1 px-2 w-24"> 
                                    <p>&euro;</p>
                                </div>
                                
                                <div class="flex gap-1 items-center">
                                    <label for="cena_do">Do:</label>
                                    <input  id="cena_do" type="number" min="0" step="1" class="border rounded-lg py-1 px-2 w-24">
                                    <p>&euro;</p>
                                </div>
                                ...
                                <div>            
                                    <div class="range-slider flex flex-col">
                                        ...
                                        <div class="flex flex-col gap-3">
                                            ...
                                            <div class="flex gap-1 items-center">
                                                <label for="cena_do">Do:</label>
                                                <input wire:model="cena_do" id="cena_do" type="number" min="0" step="1" class="border rounded-lg py-1 px-2 w-24">
                                                <p>&euro;</p>
                                            </div>
